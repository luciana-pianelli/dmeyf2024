...
AgregarVariables_IntraMes <- function(dataset) {
  ...
  dataset[, trans_quarter_visa := ctrx_quarter_normalizado  + ctarjeta_visa_transacciones]
  
  if( atributos_presentes( c("ctrx_quarter_normalizado", "ctarjeta_master_transacciones") ))
  dataset[, vtrans_quarter_master := ctrx_quarter_normalizado  + ctarjeta_master_transacciones]
  
  if( atributos_presentes( c("mcuentas_saldo", "mtarjeta_visa_consumo") ))
  dataset[, m_saldo_consumo_visa := mcuentas_saldo + mtarjeta_visa_consumo]
  
  if( atributos_presentes( c("ctrx_quarter_normalizado", "mcuentas_saldo") ))
  dataset[, quarter_mcuentas_saldo := ctrx_quarter_normalizado + mcuentas_saldo]
