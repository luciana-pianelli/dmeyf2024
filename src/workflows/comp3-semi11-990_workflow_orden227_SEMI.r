...
envg$EXPENV$exp_dir <- "~/buckets/b1/expwC3S11/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flowC3S11/"
...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1301_FE_intrames_manual_semestral09.r"
...
wf_c3SEMI11_sep_orden227 <- function( pnombrewf )
{
