...
envg$EXPENV$exp_dir <- "~/buckets/b1/expwC3S10/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flowC3S10/"
...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1301_FE_intrames_manual_exponencial09.r"
...
HT_tuning_semillerio <- function( pinputexps, semillerio, bo_iteraciones, bypass=FALSE)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/2212_HT_lightgbm_SEMI-exp.r"
...
wf_c3SEMI10_sep_orden227 <- function( pnombrewf )
{
