...
envg$EXPENV$exp_dir <- "~/buckets/b1/expwC3S3.1/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flowC3S3.1/"
...
wf_c3SEMI3.1_sep_orden227 <- function( pnombrewf )
{
