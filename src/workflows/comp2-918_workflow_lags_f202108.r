...
envg$EXPENV$exp_dir <- "~/buckets/b1/expwComp2lags/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flowComp2lags/"
...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202106, 202105, 202104,
    ...
    202008,202007,202003,202002,202001)
...
wf_agosto_lags <- function( pnombrewf )
{
