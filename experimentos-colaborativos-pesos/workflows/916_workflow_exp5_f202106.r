...
envg$EXPENV$exp_dir <- "~/buckets/b1/expwEXP4/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flowEXP4/"
...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1301_FE_intrames_manual_exp4.r"
...
wf_junio_exp4lp <- function( pnombrewf )
{
