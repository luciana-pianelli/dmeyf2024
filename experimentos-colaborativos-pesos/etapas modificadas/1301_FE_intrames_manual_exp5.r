#!/usr/bin/env Rscript
cat( "ETAPA  exp4_1301_FE_intrames_manual.r  INIT\n")
...
AgregarVariables_IntraMes <- function(dataset) {
  ...
  # Pesos customizados 
  dataset[, pesos := fifelse(foto_mes %in% c(202004, 202005), 0.2, 
                             fifelse(foto_mes == 202006, 0.1, 
                                     fifelse(substr(foto_mes, 5, 6) %in% c("04", "05", "06", "08", "09", "10", "11"), 0.9, 
                                             0.5)))]
